...
const missing = [
  {
    ...
    impact: "High",
    reason: "Appears in 6/10 roles you opened",
  },
  {
    skill: "SQL fundamentals",
    impact: "High",
    reason: "Blocks data-driven roles and growth work",
  },
  {
    skill: "Performance profiling",
    impact: "Medium",
    reason: "Improves frontend seniority signals",
  },
  {
    skill: "Accessibility audits",
    impact: "Medium",
    reason: "Common requirement for design systems",
  },
];
          ...
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="space-y-2">
              ...
              <h1 className="text-3xl font-semibold tracking-tight md:text-4xl">
                Make improvement feel lightweight
              </h1>
              <div className="max-w-2xl text-sm leading-6 text-muted-foreground">
                These are the skills that most often reduce your match score.
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <div key={m.skill} className="rounded-2xl bg-muted/40 p-4">
                      ...
                      <div className="mt-4 h-2 w-full rounded-full bg-border">
                        <div
                          ...
                          style={{
                            width: `${m.impact === "High" ? 86 : m.impact === "Medium" ? 62 : 40}%`,
                          }}
                        />
                      </div>
            ...
            <aside className="space-y-4">
              ...
              <Card className="rounded-[28px] p-6 shadow-sm">
                ...
                <div className="mt-2 text-sm leading-6 text-muted-foreground">
                  A single strong addition can shift your shortlist more than
                  five weak ones.
                </div>
              </Card>
            </aside>
